...
//		int count = 0;
	...
	public void test22() throws InterruptedException {
	    ...
	    b.accept();
//	    count++;
	    System.out.println("Thanmai is craeated");
	    
	    
	    
	    d.findElement(By.xpath("//*[contains(text(),'AAA')]//following::button[1]")).click();
	   // Thread.sleep(3000);
	    d.findElement(By.xpath("//button[text()='Delete']")).click();
	    Thread.sleep(3000);
	    d.findElement(By.xpath("//button[text()='Sign out']")).click();
	    Assert.assertTrue(d.getCurrentUrl().contains("manage"));
//	    d.findElement(By.xpath("//button [text()= 'Delete']")).click();
//	    d.close();
////	    count--;
