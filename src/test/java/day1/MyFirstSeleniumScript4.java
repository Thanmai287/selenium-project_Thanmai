...
//	public static void main(String[] args) throws InterruptedException {
	...
	public void test3() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[contains(@placeholder,'Name')]")).sendKeys("Thanmai");
		driver.findElement(By.xpath("//input[contains(@placeholder,'Email')]")).sendKeys("Thanami@gmail.com");
